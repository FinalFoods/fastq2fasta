...
This is a sample template for fastq2fasta - Below is a brief explanation of what we have generated for you:
...
```bash
sam logs -n HelloWorldFunction --stack-name fastq2fasta --tail
```
...
```bash
aws cloudformation delete-stack --stack-name fastq2fasta
```
